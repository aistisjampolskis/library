        ...
        void signUpNewMember()
        {
            try
            {
...

                {
                    ...
                    SqlCommand cmd = new SqlCommand("INSERT INTO member_master_tbl(full_name,dob,contact_no,email,region,city,postcode,full_address,member_id,password,account_status) " +
