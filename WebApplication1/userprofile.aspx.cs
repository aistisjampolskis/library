    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Response.Write("<sript>alert('Sesion Expired login again');</script>");
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                {
                    Label1.Attributes.Add("class", "bg-info");
                }
                else if (dt.Rows[0]["account_status"].ToString().Trim() == "pending")
                {
                    Label1.Attributes.Add("class", "bg-danger");
                }
                else if (dt.Rows[0]["account_status"].ToString().Trim() == "deactive")
                {
                    Label1.Attributes.Add("class", "bg-dark");
                }
                else
                {
                    Label1.Attributes.Add("class", "bg-light");
                }
