            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" Height="150px" Width="100px" src="book_inventory/istockphoto-157482029-612x612.jpg" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                         ISBN
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" placeholder="ISBN"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDBConnectionString %>" SelectCommand="SELECT * FROM [book_master_tbl]" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
                     <div class="col">
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            Description -
                                                            <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Smaller" Text='<%# Eval("book_decription") %>'></asp:Label>
