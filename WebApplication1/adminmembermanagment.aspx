            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="img/adminlogin.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-5">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control ml-1" ID="TextBox7" runat="server" placeholder="Account Status" ReadOnly="True"></asp:TextBox>
                              <asp:LinkButton class="btn btn-success ml-1" ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"><i class="fa fa-solid fa-square-check"></i></asp:LinkButton>
                              <asp:LinkButton class="btn btn-warning ml-1" ID="LinkButton2" runat="server" OnClick="LinkButton2_Click"><i class="fa-sharp fa-solid fa-circle-pause"></i></asp:LinkButton>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=localhost;Initial Catalog=elibraryDB;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [member_master_tbl]"></asp:SqlDataSource>
                     <div class="col">
